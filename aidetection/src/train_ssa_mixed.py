...
class Args:
    def __init__(self) -> None:
        ...
        self.save_model_path = "./output/mixed_ssa.pth"
        
        # output arguments
        self.output_path = "./output/mixed_ssa/"
...
train_loader = torch.utils.data.DataLoader(train_dataset, batch_size=32, num_workers=2, sampler=train_sampler)
